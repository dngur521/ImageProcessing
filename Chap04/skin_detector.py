...
def histogram_slicing(img, lowerb, upperb):
	...
	maskdst = cv2.GaussianBlur(mask, (5, 5), 0)
	dst = cv2.bitwise_and(img, img, mask = maskdst)
...
if __name__ == '__main__' :
	...
	while True:
		...
		dst1 = histogram_slicing(hsvimg, lowerb, upperb)
		skin = cv2.cvtColor(dst1, cv2.COLOR_HSV2BGR)
